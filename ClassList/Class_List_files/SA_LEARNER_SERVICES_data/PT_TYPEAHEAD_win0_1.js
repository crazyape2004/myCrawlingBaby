...
BuildList:function(theText){
    ...
    theText = this.EscapeHTMLSymbol(theText);
...
CreateBold:function(xStr,xTextMatch,xVal) {
    ...
    return this.selectSpanStart+selectSpanMid+xStr.replace(matchedText,this.undeStart+matchedText+this.undeEnd)+this.selectSpanEnd;
},
// selection on other suggestion columns
CreateBoldOtherCol:function(xStr,xVal) {
    selectSpanMid="onclick='ptTAObj_win0.SetText("+xVal+")'"+"id='OptionsList_"+this.countForId+"' theArrayNumber='"+xVal+"'>";
    this.countForId++;
    return this.selectSpanStart+selectSpanMid+xStr+this.selectSpanEnd;
},
