...
if (changed)
{
  if (typeof(url)!= 'undefined' && url != "")
  {
    ...
    if (url.substr(0,10) == "javascript")
    {
      ...
      url = "";
      saveCancelEvent = 'oParentWin.saveWarningEvent("'+url+'","'+target+'","'+actions[0]+'")'; 
      if (actions[1] != "undefined" && actions[1] != "")
        saveOKEvent = 'oParentWin.saveWarningEvent("'+url+'","'+target+'","'+actions[1]+'")';
    }
    else
      saveCancelEvent = 'oParentWin.saveWarningEvent("'+url+'","'+target+'")';
