...
// Sasank Vemana - 10/28/2012 - ISSUE ID: 31A1-1806 (Oracle Doc ID: ID 1455362.1) - Start
try {     
// Sasank Vemana - 10/28/2012 - ISSUE ID: 31A1-1806 (Oracle Doc ID: ID 1455362.1) - End
...
function MTop() {
    try {
        if (typeof top.gFocusId != 'undefined')
            return top;
...
else if (typeof top.gFocusId == 'undefined' && (window.name == "TargetContent" || window.name == "rightF"))
    ptDialog = new PT_Dialog();
...
function convToRemoteDashboardURL(sUrl,hostWin) {
    ...
    var sReturnURL = sHostURI + '/psp/'	+ sHostPSHome+sPSHomeSuffix + '/' + sHostPortalName + '/' + UniNavPortalNode +'/'+ 'h/?tab=REMOTEUNIFIEDDASHBOARD' + '&remotedburl=' + sUrl + '&unifieddashboard=y';
    return sReturnURL;			
}
